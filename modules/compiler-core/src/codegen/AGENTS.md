...
- BEAM ASM and WAT backends cover the language broadly and reuse the
  ...
  mutable closure capture across `lists:foreach`, `#[@future]` async/`await`, Fase 9
