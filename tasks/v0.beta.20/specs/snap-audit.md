...
|---|---|---|---|
| 1 | `codegen/{node,erlang,beam,wasm}/external_*.snap.md` (6 fixtures × 4 backends = 24 hits) | Legacy `#[@external(target, "…")]` form persists in fixture sources; current surface is `#[@External.<Target>("…")]` (memory `feedback_external_annotation_form`). | `prim-op` `external-target-libs-migration` (F2.2 sweep wires here when the spec lands) |
