...
`repository/botopink-lang/modules/compiler-core/`. Line numbers drift — re-locate by symbol; front
16's README already cites `template_eval.zig:329-343` where this file reads `:315-345`.
...
modules — recorded by front 16 as an unowned residual.
