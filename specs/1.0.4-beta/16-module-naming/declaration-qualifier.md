...
The maintainer accepted [option A](./options.md#option-a--the-path-joined-with-) and asked for the
...
([E18](./evidence.md#e18--the-in-file-separator-candidates)).
...
([E19](./evidence.md#e19--four-sibling-modules-from-one-source-file)):
...
([E21](./evidence.md#e21--__-has-to-be-reserved)) — a genuine, if pathological, collision. **The
...
([E18](./evidence.md#e18--the-in-file-separator-candidates)), so the choice is readability and prior
...
([E19b](./evidence.md#e19b--the-atom-decodes-back-with-no-ambiguity)):
...
([E8](./evidence.md#e8---cannot-address-anything-inside-a-module)), while `__` produces a **real
...
([E18](./evidence.md#e18--the-in-file-separator-candidates)) against the 250-byte filename cap
([E7](./evidence.md#e7--the-real-length-cap-is-the-filename-not-the-atom)). The budget is comfortable,
...
([E14](./evidence.md#e14--eleven-libsstd-module-names-are-already-otp-module-names)) closed by
construction.
