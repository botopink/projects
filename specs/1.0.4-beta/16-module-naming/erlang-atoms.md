...
|---|---|---|
| The atom is legal and the module compiles | [E3](./evidence.md#e3--e4--the-maintainers-atom-fully-quoted-works-end-to-end) | **holds** |
...
| The `.S` backend behaves identically | [E17](./evidence.md#e17) | **holds** |
| The `@comp__` prefix works | [E9](./evidence.md#e9--a-leading--forces-quoting) | **holds (quoted)** |
...
file (visible in [E7](./evidence.md#e7--the-real-length-cap-is-the-filename-not-the-atom)).
...
spelling of the same thing*. The recommendation in [`options.md`](./options.md) keeps the `@`-path
