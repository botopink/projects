...
[option A](./options.md#option-a--the-path-joined-with-) leaves byte-identical. Only the nine
...
Under [option P](./options.md#option-p--the-maintainers-proposal-as-stated) or
[option C](./options.md#option-c--the-proposal-minus--dotted-and-quoted), every `main` becomes
...
| eleven `libs/std` modules shadow an OTP module ([E14](./evidence.md#e14--eleven-libsstd-module-names-are-already-otp-module-names)), silently breaking that OTP module for the whole node ([E15](./evidence.md#e15--what-shadowing-an-otp-module-actually-does)) | `std@math`, `std@os`, `std@crypto`, … — no shadow |
