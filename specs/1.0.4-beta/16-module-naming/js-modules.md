...
[`../fronts.md` § Unowned items](../fronts.md#unowned-items), owned by 12 or 01 step 6. It is a
...
/// Erlang/BEAM: a legal unquoted atom (see specs 16-module-naming/options.md option A).
...
`erlc` demands it ([E1](./evidence.md#e1--the-module-atom-must-equal-the-source-files-basename)); the
