...
[`erlang-atoms.md` § What `#` was reaching for](./erlang-atoms.md#what--was-reaching-for).
...
basis of [option A](./options.md#option-a--the-path-joined-with-) — a path-encoding scheme that
