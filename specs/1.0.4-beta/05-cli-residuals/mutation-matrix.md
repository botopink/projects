...
>
> The matrix **was run** by 1.0.2-beta cli-gate (its step 5); record its measured verdicts in this
> front's notes before tightening. Step 4 of [`README.md`](./README.md) is the tightening.
