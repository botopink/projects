...
do not start until [`../03-wasm/`](../03-wasm/README.md) has made it.
...
([`../05-cli-residuals/`](../05-cli-residuals/README.md)) and `codegen/wat.zig` +
`libs/std/src/builtins.d.bp` ([`../03-wasm/`](../03-wasm/README.md),
`std-surface` (1.0.2-beta, landed)). They are deletions, not comment edits, so hand
