...
([`../04-js-bridges/README.md`](../04-js-bridges/README.md)). Steps 1 and 3 both edit it: **stop and
report** to agree the owner before editing. The CI install of wasmtime
(`.github/workflows/test.yml:82-100`) is [`../05-cli-residuals/`](../05-cli-residuals/README.md)'s, and
[`../09-hygiene/wat-runtime.md`](../09-hygiene/wat-runtime.md) waits on this decision to keep or drop
it.
...
evaluator path) goes with the deletion. `libs/std/src/builtins.d.bp` is owned
by no front this milestone — hand that line to [`../09-hygiene/`](../09-hygiene/README.md) (group A)
rather than editing it. `build.zig:17`, `:95`, `src/codegen/config.zig:22-23` and `src/codegen/runtime.zig:548-549` also
name `wasm3`; those are [`../09-hygiene/wat-runtime.md`](../09-hygiene/wat-runtime.md)'s, not this
step's.
