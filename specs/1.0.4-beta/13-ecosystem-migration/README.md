...
2. Library-specific edits:
   ...
   - **emilia** — the 27 section annotations become path names (`TokenText` → `Token.Text`, `TokenTextSize` → `Token.Text.Size`, decision 8 §5.3b); it lands in the same sweep as 06's C8/C10, which is what types those bindings;
