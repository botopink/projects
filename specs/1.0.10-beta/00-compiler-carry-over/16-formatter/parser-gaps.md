> Carried from `specs/1.0.5-beta/16-formatter/parser-gaps.md`, status at carry (2026-09-20): steps 1–7 and decision 61 landed; decision 65 is C-12 (uncommitted in `.tasks/formatter`), the `;` printer half is C-13, `arrow_when_empty` is C-11
