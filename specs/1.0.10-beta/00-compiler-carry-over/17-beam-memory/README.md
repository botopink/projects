...
question left from that pass, [52](../../../1.0.5-beta/decisions-pending.md), belongs to the loop lowering.
...
A module-level `var` is [decision 28](../../../1.0.5-beta/decisions-taken.md#28-what-decision-14-left-unassigned)'s
...
It is the shape [decision 37](../../../1.0.5-beta/decisions-taken.md#37-is-a-record-immutable) found for record fields —
...
[decision 17](../../../1.0.5-beta/decisions-taken.md#17-rakuns-erlang-story)'s container-and-router half, and this front
...
[`10-cli-residuals`](../../../1.0.5-beta/10-cli-residuals/README.md)'s defect). Since the family already covers both
...
[decision 15](../../../1.0.5-beta/decisions-taken.md#15-a-lower-case-externalnode-) already named for `#[@external]`
...
[decision 17](../../../1.0.5-beta/decisions-taken.md#17-rakuns-erlang-story), so this front **specifies** the module
and 09 lands it.
...
| With | Verdict | Why |
|---|---|---|
| **01 checker** | **no — carve-out or the front does not open** | `src/comptime/infer.zig` is 01's. This front needs **two diagnostics** beside decision 37's at `:2742`: assignment to a `val`, and the `Ets` initialiser rule. The same shape [`14`](../14-comptime-on-beam/README.md) was granted for two `evaluate(…)` call sites. Separately, step 3's annotation validation is the annotation grammar, which [decision 15](../../../1.0.5-beta/decisions-taken.md#15-a-lower-case-externalnode-) assigns to 01 — register it there rather than restate it |
...
| **09 ecosystem-residuals** | **seq — 17 specifies, 09 lands** | `libs/std/**` and `repository/{emilia,rakun}/**` are 09's. **Step 3b's `libs/std/src/beam.bp` is specified here and written there** — it is the layer-1 half of question 43 and needs no compiler change. Step 8 produces the migration, including the 96 lines and 13 declarations rakun sheds, and registers it against [decision 17](../../../1.0.5-beta/decisions-taken.md#17-rakuns-erlang-story) rather than doing it |
