...
Mechanically valid ([E3](./atom-evidence.md#e3--e4--the-maintainers-atom-fully-quoted-works-end-to-end),
[E17](./atom-evidence.md#e17)). Costs B1–B7 in
...
[E14](./atom-evidence.md#e14--eleven-libsstd-module-names-are-already-otp-module-names) plus the rest of
...
([E10](./atom-evidence.md#e10--what-is-and-is-not-a-legal-unquoted-atom), [E12](./atom-evidence.md#e12---joined-atoms-need-no-quoting-anywhere)),
...
[E1](./atom-evidence.md#e1--the--module-atom-must-equal-the-source-files-basename) forces the file's
...
Legal ([E3](./atom-evidence.md#e3--e4--the-maintainers-atom-fully-quoted-works-end-to-end) proves the
...
option A was chosen and landed, so the claim is recorded as unverified and no longer weighs.
...
the atom `#Pessoa` would be text the BEAM never reads ([E8](./atom-evidence.md#e8---cannot-address-anything-inside-a-module)).
