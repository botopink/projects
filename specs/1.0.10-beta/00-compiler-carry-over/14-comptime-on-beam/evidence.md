> Carried from `specs/1.0.5-beta/14-comptime-on-beam/evidence.md`, status at carry (2026-09-20): steps 0–2 landed (`bef762be`); step 3 is C-20, after C-01 (decisions 24 and 62)
...
recorded by [`../13-module-identity/`](../13-module-identity/README.md)).
