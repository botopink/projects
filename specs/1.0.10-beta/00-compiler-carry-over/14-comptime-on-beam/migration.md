...
**Owner note:** `scripts/**` is [`../../1.0.4-beta/05-cli-residuals/`](../../../1.0.4-beta/05-cli-residuals/README.md)'s, delivered;
...
| never purges a loaded module | **the pressure is gone** — one module per declaration instead of one per call site; `code:purge/1` on reload of a changed declaration becomes worth adding, and closes the unowned residual [13-module-identity](../13-module-identity/README.md) recorded | the same |
...
| `jhonstart` | 10 templates | — (not measured; its examples are known-broken, [`../09-ecosystem-residuals/`](../09-ecosystem-residuals/README.md)) | — |
