...
**Track:** B rakun
**Priority:** critical — without it `onze` can only ever serve dynamically: every page re-renders per
...
the `strict`-frame raise (front 62 owns it and asserts it) and the CLI wiring of `onze build`
