...
| 51 · 52 | `Image(props, cfg, publicDir)`, `googleFont(family, opts) -> @Task<Font>`, `fontHead(fonts) -> string` | These are fronts 51 and 52's own shapes, defined in this milestone by the same author; nothing external has confirmed them |
