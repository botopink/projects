...
- **The compiler knows none of the libraries** (1.0.9). Only `00-compiler-carry-over` touches
  ...
  (`01-std/04-routing-lib`, decision 115). The bundled `routing` library is neutral like std: rakun
  and jhonstart both import it, and that is not an edge between them.
