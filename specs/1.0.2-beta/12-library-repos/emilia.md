...
[`../11-hygiene/decisions.md`](../11-hygiene/decisions.md) item 5.5.
...
The install-path answer is [`../11-hygiene/decisions.md`](../11-hygiene/decisions.md) 5.5 (b), and
...
2. Add a `.github/workflows/test.yml` matching the siblings', with the `BOTOPINK_LANG_REF` default
   settled in [`vscode-extension.md`](./vscode-extension.md) 7g.
