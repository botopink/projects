...
directory [`../01-comptime-dispatch/`](../01-comptime-dispatch/README.md),
[`../07-checker/`](../07-checker/README.md) and
[`../10-comptime-dedup/`](../10-comptime-dedup/README.md) all move. Land it when none of them is in
...
[`../07-checker/`](../07-checker/README.md), which owns `parser/{decls,exprs,patterns}.zig`.
...
| `comptime/infer.zig`, `comptime/env.zig`, `parser/decls.zig` | [`../07-checker/`](../07-checker/README.md) |
| `codegen/tests/**`, `comptime/tests/**` | [`../09-review-tooling/`](../09-review-tooling/README.md) |
| `libs/std/src/http.bp` | [`../03-std-surface/`](../03-std-surface/README.md) |
