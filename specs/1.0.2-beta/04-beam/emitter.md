...
| `src/codegen/erlang.zig` | 2 | `:1584` / `:1587` — the `$stringify(…)` wrapper, owned by [`../05-erlang/raw-rows.md`](../05-erlang/raw-rows.md) |
