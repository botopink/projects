...
|---|---|---|
| `:3175` (bare `throw`) | `src/codegen/commonJS.zig:2224` (`Stmt.throw_ = null` → `throw;`, a SyntaxError) | what a bare `throw` means — rethrow the caught value, or reject it in the checker. [`../08-js-bridges/bridges.md`](../08-js-bridges/bridges.md) JS-6 |
...
`:2693`, `:2710` — see [`../04-beam/emitter.md`](../04-beam/emitter.md).
