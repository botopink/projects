...
never unified" rows ([`../07-checker/rows.md`](../07-checker/rows.md) M1 / C2 / C8 / C9);
...
[`../07-checker/rows.md`](../07-checker/rows.md) groups the same 17 as 10 `case` + 4 extension +
...
- **A block arm is recognised by shape.** `:350-352` treats a zero-parameter `.lambda` as a block —
  ...
  [`../09-review-tooling/semantics-decisions.md`](../09-review-tooling/semantics-decisions.md#decision-2)).
