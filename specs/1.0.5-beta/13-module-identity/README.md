...
(01, [`../06-comptime-dedup/`](../06-comptime-dedup/README.md)) · `libs/std/**` and
...
- **13 × 02 and 13 × 03 — 02 and 03 stall while 13's halves 2–3 run.** 13 owns
  ...
  no split of D8-1/D8-2/D8-3/D8-5 is needed** ([`13-module-identity/halves-and-ordering.md`](./13-module-identity/halves-and-ordering.md) § 5).
