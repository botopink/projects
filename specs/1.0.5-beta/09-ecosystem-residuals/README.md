...
[`10-cli-residuals`](../10-cli-residuals/README.md) for the `.erl` half of `build`/`run`. Steps 1 and 2
can start now
...
```markdown
| **09** [`ecosystem-residuals`](./09-ecosystem-residuals/README.md) | `repository/{emilia,erika,jhonstart,onze,rakun}/**`; their meta submodule pointers | the libraries' own test outputs and examples | not started — steps 1–2 ready; step 3 after 01, step 4 after 13 |
```
